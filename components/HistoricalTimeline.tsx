...
type CategoryKey = "worldEvents" | "tech" | "popCulture" | "music" | "movies";
...
export default function HistoricalTimeline({ birthYear }: Props) {
  ...
  const CATEGORIES = [
    { key: "worldEvents" as CategoryKey, label: t.history.worldEvents },
    { key: "tech" as CategoryKey, label: t.history.tech },
    { key: "popCulture" as CategoryKey, label: t.history.popCulture },
    { key: "music" as CategoryKey, label: t.history.music },
    { key: "movies" as CategoryKey, label: t.history.movies },
  ];
  ...
  return (
    <div className="card p-5">
      <h3 className="font-bold text-lg mb-1">
        <span className="gradient-text">{t.history.heading} {birthYear}</span>
      </h3>
